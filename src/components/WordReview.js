...
function WordReview({ setStatus, setSelectedKana, isHiragana, selectedWords, wrongWords, setIsHiragana, setMaxNumberOfWords }) {
    ...
    return (
        <><h1>List of reviewed words</h1>
            ...
            <button type="button" className="start" onClick={() => { setStatus("start"); setSelectedKana(doubleSounds); setIsHiragana(true); setMaxNumberOfWords(10) }}>Start New Game</button>
        </>)
}
